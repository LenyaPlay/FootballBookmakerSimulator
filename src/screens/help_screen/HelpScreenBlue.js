...
function HelpScreenBlue() {
  ...
  return (
    <div className={`${style.helpScreenBlue} ${style.blue}`}>
      <p>O período atual do torneio é mostrado aqui</p>
        <img src={require("src/assets/blue_design/img/1.png")}></img>
        <p>Essa é a força do time, quanto maior a força, maiores as chances de vitória</p>
        <img src={require("src/assets/blue_design/img/2.png")}></img>
        <p>Aqui você faz uma aposta, precisa selecionar um time e inserir o valor</p>
        <img src={require("src/assets/blue_design/img/3.png")}></img>
        <p>É assim que o resultado é exibido</p>
        <img src={require("src/assets/blue_design/img/4.png")}></img>
        <p>Para saber os resultados, você deve clicar no seguinte botão</p>
        <img src={require("src/assets/blue_design/img/5.png")}></img>
        <p>Ao final do campeonato você saberá quanto ganhou ou perdeu nas apostas</p>
        <img src={require("src/assets/blue_design/img/6.png")}></img>
        <p>Ao final do campeonato você saberá quanto ganhou ou perdeu nas apostas</p>
        <img src={require("src/assets/blue_design/img/7.png")}></img>
